...
namespace ELearning.Infrastructure.Migrations
{
    ...
    [Migration("20241201113853_DeletePropFromCategoryTablr")]
    partial class DeletePropFromCategoryTablr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Answer", b =>
                {
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Comment", b =>
                {
                    ...
                    b.Property<DateTime?>("UpdatedCommentedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("EnrollmentId", "PaymentId")
                        .IsUnique();

                    b.ToTable("Payment");
                });

            modelBuilder.Entity("ELearning.Data.Entities.Question", b =>
                {
                    b.Property<Guid>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QuestionId", "Text", "QuizId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Quiz", b =>
                {
                    ...
                    b.HasIndex("QuizId", "LessonId")
                        .IsUnique();

                    b.HasIndex("Title", "QuizId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Answer", b =>
                {
                    ...
                    b.HasOne("ELearning.Data.Entities.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("ELearning.Data.Entities.Comment", b =>
                {
                    b.HasOne("ELearning.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany("Comments")
